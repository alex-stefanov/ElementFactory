...
namespace ElementFactory.Data.Migrations
{
    ...
    [Migration("20240128200809_CorrectedSeveralQuestionInTest8GradeMigration")]
    partial class CorrectedSeveralQuestionInTest8GradeMigration
    {
            ...
            modelBuilder.Entity("ElementFactory.Data.Models.Question", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 43,
                            Description = "Какъв е цветът на пламъка при гореното на Ca?",
