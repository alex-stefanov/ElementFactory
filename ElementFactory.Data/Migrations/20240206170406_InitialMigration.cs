        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Натрият взаимодейства със: ", true, "Неметали, киселини и вода" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 37, "Реакцията \"Гасене на вар\" е ракция на CaO с вода, при коята се получава/т:", true, "Ca(OH)2" },
                    ...
                    { 43, "Какъв е цвета на пламъка при гореното на Ca?", true, "Керемиденочервен" },
                    { 44, "Реакцията \"Шумяща проба\" се наблюдава при взаимодействието на:", true, "CaCO3 с киселина" },
                    { 45, "Разтоворът на Ca(OH)2 е с pH:", true, "11" },
                    ...
                    { 55, "\"Хидрирането\" на алкени протична при наличието на:", true, "И трите изброени" },
                    { 56, "Наличието на какво се доказва с разтвор на KMnO4?", true, "Сложни връзки" },
                    { 57, "При присъединяването на полярни H-съдържащи молекули към молекули на несиметрияни алкени се спазва правилото на:", true, "Марковников" },
                    ...
                    { 59, "2,4,6-тринитро толуен(TNT) се получава при взаимодействието на:", true, "Толуен и HNO3 в излишък" },
                    { 60, "При взаимодействието на фенол и натрий се получава:", true, "Натриев феноксид и 1/2 H2" },
                    { 61, "Топлината на образуване на 1 мол хлороводор е 92.5kJ.Какъв е топлинният ефект на реакцията: H + Cl => HCl (Уравнението не е изравнено!) в kJ?", true, "185" },
                    ...
                    { 64, "Ако температурата на образуване на водните пари е 242.5kJ, то тогава колко е температурата им на изгаряне сметната в kJ и закръглена до първия знак след запетаята?", true, "-242.5" },
                    ...
                    { 67, "Ако в хомогенният едностадиен процес 2CO + O2 => 2CO2, концентрацията на CO се увеличи 3 пъти при t=const то с колко пъти новата скорост ще е по-голяма от старата", true, "9" },
                    { 68, "2SO2(г) + O2(г) => 2SO3(г) + Q. Ако увеличим налягането на системата три пъти, то с колко новата средна скорост на уравнението ще бъде по-голямата от тази на началното уравнение", true, "27" },
                    { 69, "S(тв) + H2(г) => H2S(г) + 4.8kJ. Изчислете количеството обменена топлина в kJ, закръглено до първия знак след запетаята, ако 8грама сяра реагират по даденото химияно уравнение(счита се,че M(S)=32.0)", true, "1.2" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 87, "Кое е най-точното определение на \"Електронен облак\"?", true, "Част от пространството, което е около самото ядро, в която шанса за намиране на електрона е приблизително 90%" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 201, true, 54, "Вярно" },
                    { 202, true, 54, "Грешно" },
                    { 203, true, 55, "Температура" },
                    { 204, true, 55, "Налягане" },
