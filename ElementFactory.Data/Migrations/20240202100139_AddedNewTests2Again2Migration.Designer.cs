...
namespace ElementFactory.Data.Migrations
{
    ...
    [Migration("20240202100139_AddedNewTests2Again2Migration")]
    partial class AddedNewTests2Again2Migration
    {
            ...
            modelBuilder.Entity("ElementFactory.Data.Models.Question", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 79,
                            Description = "Процесът на кристализация е проведен с положителен топлинен ефект(+Q1)",
                            RightAnswer = "Грешно"
                        },
                        new
                        {
                        ...
                        {
                            Id = 82,
                            Description = "Ако имаме една кръвна,на която цитозолата е с концетрация 0.9%, а кръвта около нея е с концентрация по-висока от 1.2%, то спрямо клетката, разтвора в околната среда(кръвта) ще бъде:",
                        ...
                        {
                            Id = 84,
                            Description = "Какви видове разтвори има според степнта на електролитна дисоциация?",
                        ...
                        {
                            Id = 86,
                            Description = "Коя от частиците е с най-малък радиус?",
                            RightAnswer = "Al3+"
                        },
                        new
                        {
                        ...
                        {
                            Id = 103,
                            Description = "При изгарянето на 9грама алуминий, като знаете че M(Al)=27g/mol, в кислородна среда се отделят 229kJ топлина. Това означава,че стандартната енталпия на образуване на диалуминиевия триоксид е равна на:",
                        ...
                        {
                            Id = 106,
                            Description = "Ако преимем, че реакцията протича по уравнението: S(тв.) + O2(г.) => SO2(г.), то кинетичното уравнение за процеса е:",
                        ...
                        {
                            Id = 110,
                            Description = "Кое от следните опредления описва \"Вторият закон на Фарадей\"",
                        ...
                        {
                            Id = 111,
                            Description = "При еднаква молна концентрация и температура = const, най-високото осмотично налягане от посочените по долу има ряазтворът на:",
